...
import {UpdateItem, PostItem, DeleteItem} from "../Redux/Actions/CardAction"
...
class EditScreen extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            descriptionPlaceholder: "一句话鼓励自己",
            titleText: uuid
...
const mapDispatchToProps = ({UpdateItem, PostItem, DeleteItem});
